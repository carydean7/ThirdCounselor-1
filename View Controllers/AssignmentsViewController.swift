...
class AssignmentsViewController: BaseViewController, InformationAlertDelegate {
    let contentView = UIHostingController(rootView: AssignmentsSnapshotListView(membersViewModel: MembersViewModel.shared))
    ...
    func setViewModelFlags() {
        ...
        AssignmentsViewModel.shared.shouldShowAddItemButton = false
        NotesViewModel.shared.shouldShowAddItemButton = false
    }

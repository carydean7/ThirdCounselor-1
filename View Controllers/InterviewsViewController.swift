...
//  ThirdCounselor
//
//  Created by Dean Wagstaff on 6/11/22.
//

import SwiftUI
import UIKit

class InterviewsViewController: BaseViewController, InformationAlertDelegate {
    var closeButton: UIButton?
    var senderIsMemberButton: UIButton?
    var ldrAssignToDoInterview = ""
    var name = ""
    var selectedInterviewType = ""
    var selectedLeader = ""
    var shouldAnimateTableView = true
    var leaderSelectionAlert: UIAlertController?
    var interviewTypesSelectionAlert: UIAlertController?
    var assignedInterviewsAlert: UIAlertController?
    var selectionAlert: UIAlertController?
    var membersTableView: UITableView?
    var interviewTypesTableView: UITableView?
    var leadersTableView: UITableView?
    var infoAlert: UIAlertController?
    
    let contentView = UIHostingController(rootView: InterviewsListView(membersViewModel: MembersViewModel.shared, interviewsViewModel: InterviewsViewModel.shared))
    ...
    override func viewDidLoad() {
        ...
        InterviewsViewModel.shared.shouldShowAddItemButton = true

...
class PrayersViewController: BaseViewController, InformationAlertDelegate {

    let contentView = UIHostingController(rootView: PrayersListView(membersViewModel: MembersViewModel.shared, viewModel: PrayersViewModel.shared))

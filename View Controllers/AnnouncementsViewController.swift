...
class AnnouncementsViewController: BaseViewController, InformationAlertDelegate {
    let contentView = UIHostingController(rootView: AnnouncementsListView(viewModel: AnnouncementsViewModel.shared))

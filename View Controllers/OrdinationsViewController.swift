//
//  OrdinationsViewController.swift
//  ThirdCounselor
//
...
class OrdinationsViewController: BaseViewController, InformationAlertDelegate {

    let contentView = UIHostingController(rootView: OrdinationsListView(viewModel: OrdinationsViewModel.shared))
